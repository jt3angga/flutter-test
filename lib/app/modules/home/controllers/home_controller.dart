...
class HomeController extends GetxController {
  ...
  getHospitalByCode(String code) {
    return code == 'semua' ? _hospitalDetailList : _hospitalDetailList.where((row) => row["code"] == code).toList();
  }
  ...
  // dummy data
  final _kliniklDetailList = [
    {
      'name': 'Klinik Fatmawati',
      'alamat': 'Alamatnya 1',
      'code': 'bp',
      'image': 'assets/images/image1.jpeg'
    },
    {
      'name': 'Klinik Eka Hospital',
      'alamat': 'Alamatnya 2',
      'code': 'bp',
      'image': 'assets/images/image2.jpeg'
    },
  ...
  getKlinikByCode(String code) {
    return code == 'semua' ? _kliniklDetailList : _kliniklDetailList.where((row) => row["code"] == code).toList();
  }
